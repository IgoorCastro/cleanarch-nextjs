...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\tiuigo\\Documents\\Projetos Next\\clean arch + nextjs\\exercicio01\\src\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\tiuigo\\Documents\\Projetos Next\\clean arch + nextjs\\exercicio01\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:973164@localhost:5432/NextJs+CleanArch?schema=exerc01"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  name      String\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "a53ffeed6b10e0057bf2ef45c9258bdfe17f98a713f707072aa6f78d7db8291d",
  "copyEngine": true
}
config.dirname = '/'
